 ...
 */
final class SwipeBakedBezierInterpolator implements Interpolator {
    private static final SwipeBakedBezierInterpolator INSTANCE = new SwipeBakedBezierInterpolator();

    public final static SwipeBakedBezierInterpolator getInstance() {
        return INSTANCE;
    }
     ...
     */
    private SwipeBakedBezierInterpolator() {
        super();
    }
