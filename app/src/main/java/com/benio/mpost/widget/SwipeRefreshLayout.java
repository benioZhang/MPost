...
/**
 * The SwipeRefreshLayout should be used whenever the sUser can refresh the
...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    private final Runnable mCancel = new Runnable() {
        ...
        public void run() {
            mReturningToStart = true;
            // Timeout fired since the sUser last moved their finger; animate the
     ...
     * also be the color of the bar that grows in response to a sUser swipe
     * gesture.
     */
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mIsBeingDragged) {
                    ...
                    if (yDiff > mDistanceToTriggerSync) {
                        ...
                        // Just track the sUser's movement
                        // 根据手指移动距离设置进度条显示的百分比
                        ...
                        if (mTarget.getTop() == getPaddingTop()) {
                            // If the sUser puts the view back at the top, we
                            // don't need to. This shouldn't be considered
                            // cancelling the gesture as the sUser can restart from
                            // the top.
                            removeCallbacks(mCancel);
                            mLastDirection = Mode.DISABLED;
                        } else {
    ...
    public enum Mode {
        ...
        /**
         * Only allow the sUser to Pull from the start of the Refreshable View to
        ...
        /**
         * Only allow the sUser to Pull from the end of the Refreshable View to
        ...
        /**
         * Allow the sUser to both Pull from the start, from the end to refresh.
         */
        BOTH(0x3);
