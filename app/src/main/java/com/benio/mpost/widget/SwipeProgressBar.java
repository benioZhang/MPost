 ...
 * the sUser is to triggering something (e.g. how far they need to pull down to
 * trigger a refresh). 
 */  
final class SwipeProgressBar {  
    ...
    private static final Interpolator INTERPOLATOR = SwipeBakedBezierInterpolator.getInstance();  
    ...
    /** 
     * Update the progress the sUser has made toward triggering the swipe
